    ...
    >
        ...
        <div className="px-5 py-3 border-t border-separator flex items-center justify-end gap-2">
          ...
          <button
            ...
            className="h-8 px-3 rounded bg-accent hover:bg-accent-hover disabled:opacity-40 disabled:cursor-not-allowed text-text-inverse text-md font-medium transition-colors"
          >
    ...
    <>
      ...
      <div className="fixed inset-x-0 top-0 z-40 flex h-12 items-center justify-between border-b border-separator bg-surface-raised px-3 md:hidden">
        ...
        <div className="flex items-center gap-1.5">
          <Link
            href="/jobs/new"
            className="h-7 px-3 rounded bg-accent hover:bg-accent-hover text-text-inverse text-md font-medium transition-colors inline-flex items-center gap-1.5"
          >
        ...
        <div className="fixed inset-0 z-50 md:hidden" onClick={() => setMobileOpen(false)}>
          ...
          >
            ...
            <div className="px-2 pt-2">
              <Link
                href="/jobs/new"
                className="h-7 w-full rounded bg-surface-hover hover:bg-surface-hover-strong text-text-primary text-md font-medium border border-separator transition-colors inline-flex items-center justify-center gap-1.5"
              >
                <Plus className="w-3.5 h-3.5" />
                New Job
              </Link>
      ...
      <aside className="hidden md:flex flex-col h-screen sticky top-0 w-60 flex-shrink-0 bg-surface-raised border-r border-separator">
        ...
        <div className="flex items-center justify-between px-3 py-3 border-b border-separator">
          ...
          <Link
            href="/jobs/new"
            className="h-7 px-2.5 rounded bg-surface-hover hover:bg-surface-hover-strong text-text-primary text-xs font-medium border border-separator transition-colors inline-flex items-center gap-1"
            title="New job"
          >
            <Plus className="w-3 h-3" />
            New
